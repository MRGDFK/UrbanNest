            ...
            <section class="hero">
                <div class="container">
                    ...
                    <div class="hero-container">
                            ...
                            <h1 class="headline-large hero-title"> Register as AGENT </h1>
                            <br>
                            <div class="box form-box">
                                <form action="<?php htmlspecialchars($_SERVER["PHP_SELF"])?>" method="post">
                                    <div class="field input">
                                        <label for="email" style="color: #0D3166;">Name</label>
                                        <input type="text" name="name" id="email" autocomplete="off" required>
                                    </div>

                                    <div class="field input">
                                        <label for="email" style="color: #0D3166;">Username</label>
                                    ...
                                    <div class="field">
                                        ...
                                        <input type="submit" class="btn-f" name="submit" value="Signup" required>
                                    </div>
...
<?php
    if($_SERVER["REQUEST_METHOD"]== "POST"){
        ...
        elseif(empty($password)){
            ...
            $sql = "INSERT INTO agent(agent_name, agent_username, agent_email, agent_password) VALUES
