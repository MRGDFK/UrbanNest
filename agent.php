        ...
        <div class="container">
            ...
            <nav class="navbar" data-navbar>
                ...
                <div class="navbar-wrapper">
                    <a href="login.php" class="btn-link label-medium"> Agent Login </a>
            ...
            <section class="hero">
                <div class="container">
                    ...
                    <div class="hero-container">
                            ...
                            <h1 class="headline-large hero-title">Agent Login </h1>
                            <br>
                            <div class="box form-box">
                                <form action="" method="post">
                                    <div class="field input">
                                        <label for="email" style="color: #0D3166;">Agent Email</label>
                                        <input type="text" name="email" id="email" autocomplete="off" required>
                                    </div>

                                    <div class="field input">
                                        <label for="password" style="color: #0D3166;">Agent Password</label>
...
<?php
        if (isset($_POST['submit'])) {
            ...
            if (is_array($row) && !empty($row)) {
                ...
                $_SESSION['agent_username'] = $row['agent_username'];
            } else { 
                echo '
                <script>
                    swal({
